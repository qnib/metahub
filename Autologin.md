...
```bash
docker pull -q public.ecr.aws/a4y4t9s0/metahub-autologin:v0.2.8
docker run -ti --rm --network=host -v /var/run/docker.sock:/var/run/docker.sock public.ecr.aws/a4y4t9s0/metahub-autologin:v0.2.8 autologin -docker-login -aws-region=eu-west-1
